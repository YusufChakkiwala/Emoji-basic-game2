<<<<<<< HEAD
const emojis=[
    {symbol: '😀  Happy', mood: 'Happy',color:"pink"},
    {symbol: '😢  Sad', mood: 'Sad',color:"blue"},
    {symbol: '😠  Angry', mood: 'Angry',color:"red"},
    {symbol: '😱  Scared', mood: 'Scared',color:"yellow"},
    {symbol: '😎  Cool', mood: 'Cool',color:"green"},
    {symbol: '😴  Sleepy', mood: 'Sleepy',color:"purple"},
    {symbol: '🤔  Thinking', mood: 'Thinking',color:"orange"},
];
...
>>>>>>> 5bc59756f57d050584635ae13ee7fd4a36ec2127
